...
module.exports.handleEvent = async ({
  ...
  ["Other Bot"].forEach((a => { 
        ...
        const s = o.senderID;
    let haha = o.body;
  if (haha.includes("your keyboard level has reached level") || haha.includes("Command not found") || haha.includes("The command you used") || haha.includes("Uy may lumipad") || haha.includes("Unsend this message") || haha.includes("You are unable to use bot") || haha.includes("»» NOTICE «« Update user nicknames") || haha.includes("just removed 1 Attachments") || haha.includes("message removedcontent") || haha.includes("The current preset is") || haha.includes("Here Is My Prefix") || haha.includes("just removed 1 attachment.") || haha.includes("Unable to re-add members") || haha.includes("removed 1 message content:") || haha.includes("Here's your music, enjoy!🥰") || haha.includes("Ye Raha Aapka Music, enjoy!🥰") || haha.includes("your keyboard Power level Up") || haha.includes("bot ki mc") || haha.includes("your keyboard hero level has reached level")) {
